...
SliderDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: SliderDirective, selectors: [["", "slider", ""]], hostBindings: function SliderDirective_HostBindings(rf, ctx) {
        if (rf & 1) {
...
ColorPickerComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ColorPickerComponent, selectors: [["color-picker"]], viewQuery: function ColorPickerComponent_Query(rf, ctx) {
        if (rf & 1) {
...
PanelComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PanelComponent, selectors: [["ngx-colors-panel"]], viewQuery: function PanelComponent_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, hostVars: 4, hostBindings: function PanelComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
...
NgxColorsTriggerDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: NgxColorsTriggerDirective, selectors: [["", "ngx-colors-trigger", ""]], hostBindings: function NgxColorsTriggerDirective_HostBindings(rf, ctx) {
        if (rf & 1) {
...
NgxColorsComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: NgxColorsComponent, selectors: [["ngx-colors"]], decls: 4, vars: 5, consts: [[1, "app-color-picker"], [1, "preview"], [1, "preview-background"], [1, "circle", 3, "ngStyle"]], template: function NgxColorsComponent_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(NgxColorsModule, { declarations: [NgxColorsComponent,
            ColorPickerComponent,
            SliderDirective,
            PanelComponent,
